<template>
  <div>
      ...
      <v-card class="detailsBorderColor">
        <v-card-title class="justify-center">
          <span class="primary--text font-italic headline" primary-title
            >Choose appointment doctor</span
          >
        </v-card-title>
        <v-card-actions class="justify-center pr-10 pb-10">
          <v-btn color="primary" @click="regularDoctor">Regular doctor</v-btn>
          <v-btn color="primary" @click="specialistDoctor"
            >Specialist doctor</v-btn
          >
        </v-card-actions>
      </v-card>
    </div>
    <v-card
      v-if="regular == true && checkP == false"
      class="detailsBorderColor"
    >
      <v-card-title>
        <span class="primary--text font-italic headline" primary-title
          >Create appointment to Regular doctor</span
        >
      </v-card-title>
      <v-card-text>
        <v-container>
    ...
    <v-card
      v-if="specialist == true && checkP == false"
      class="detailsBorderColor"
    >
      <v-card-title>
        <span class="primary--text font-italic headline" primary-title
          >Use recommendation for specialist</span
        >
      </v-card-title>
      <v-card-text>
        <v-container>
